...
const MethodologyData = [
  {
    id: 1,
    icon: BrainCircuit,
    title: 'Автоматизм через осознанное заучивание',
    description: 'Да, мы используем заучивание — но не механическое. Ключевые фразы, паттерны и мини-диалоги становятся вашими «строительными блоками» для свободной речи.',
  },
  {
    id: 2,
    icon: Route,
    title: 'Индивидуальный темп и снятие страхов',
    description: 'Начнём с вашей текущей точки — без тестов, без давления. Работаем с вашим графиком и целями.',
  },
  {
    id: 3,
    icon: BookOpenCheck,
    title: 'Системность и аутентичность',
    description: 'Учебники Cambridge/Oxford + авторские материалы. Грамматика — через контекст, а не правила. Язык — как инструмент для жизни.',
  },
];
